...
////////////////////////////////////////////////////////////////////////////////
static double expiryCallValue(double S, double X, double vDt, int i, int NUM_STEPS)
{
...
{
    const int NUM_STEPS = optionData.n;
    ...
    for (int i = 0; i <= NUM_STEPS; i++)
        Call[i] = expiryCallValue(S, X, vDt, i,NUM_STEPS);
