...
\todo{Correct algorithm~\ref{alg:sobol-parallel-2}}
\begin{algorithm}
  \begin{algorithmic}
...
In the same paper \todo[noinline]{it is technically not a paper, what
  is it then?} they present skip-ahead strategies for two PRNGs, the
Mersenne Twister (the MT19937 variant) and L'Ecuyer's Multiple
