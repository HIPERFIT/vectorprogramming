...
\paragraph{Portability.} Accelerate consists of a frontend package,
\texttt{accelerate}, that defines the language, and of various backend
packages, most notably \texttt{accelerate-cuda}, that defines compilers or
interpreters for Accelerate terms.
