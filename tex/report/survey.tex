...
\paragraph{Dependencies.} %
packages,extensions, portability impediments.  Repa uses 18 GHC extensions and
depends on 6 other established packages, none specific to any platform.  Thus,
Repa will most probably function on any machine that is targetable by GHC.
