...
optimisations such as loop fusion must be coded by hand, outruling the use of
such libraries. This optimisation often has profound effects on performance
...
typeclass \texttt{Compilable a b}, denoting that a value of type
