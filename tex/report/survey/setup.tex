...
by financial engineers \todo{cite - that both are used in
  finance}. The R language is used for expressing financial algorithms
...
and Schwartz algorithm in neither Nikola or Accelerate \todo{make sure
  this is indeed written down somewhere}.
...
performance of the language. The following three chapters will pose
