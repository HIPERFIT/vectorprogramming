...
our sample programs does not insert unnecessary clutter, that
performance can be obtained by writing in an idiomatic style for the
language and \ldots\todo{extend and elaborate}.
...
\subsection{Performance} In the last section we want to establish how the
