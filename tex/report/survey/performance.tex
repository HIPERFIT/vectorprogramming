...
parameters, mandating the use of the llvm code generation backend and level-3
optimizations (via \verb|-optlo-O3|.  Each of the CUDA benchmarks have been
...
versions implemented in R, Repa and \lstinline{Data.Vector}. 

The R implementation is from the R-package \lstinline{randtoolbox} which
...
also the algorithm we have implemented in \lstinline{Data.Vector}, but in
