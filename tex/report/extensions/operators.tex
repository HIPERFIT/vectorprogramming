...
In order to be useful however, \lstinline{unfoldr} by itself is not enough.  We
...
the case of \lstinline{unfoldr} we thus must express the resulting shape beforehand.
...
\todo{explain how that would be outside our
...
\lstinline{Map} in module \lstinline{Data.Array.Nikola.Operators.Mapping}.
...
mapped version of \lstinline{unfold}, the outer structure of the computation is
